...
export class AlunoService {
  ...
  getAlunosMatriculados(): Observable<AlunoInterface[]> {
    return this.httpClient.get<Array<AlunoInterface>>(this.apiUrl, {
  ...
  postAluno(aluno: AlunoInterface): Observable<any> {
    return this.httpClient.post<any>(this.apiUrl, aluno, {
      headers: this.getHeaders(),
    });
  }

  putAluno(aluno: AlunoInterface): Observable<any> {
    return this.httpClient.put<any>(`${this.apiUrl}/${aluno.id}`, aluno, {
      headers: this.getHeaders(),
    });
  }
