...
export class DocentesService {
  ...
  getDocentesMatriculados(): Observable<DocenteInterface[]> {
    return this.httpClient.get<Array<DocenteInterface>>(this.apiUrl, {
  ...
  postDocente(docente: DocenteInterface): Observable<any> {
    return this.httpClient.post<any>(this.apiUrl, docente, {
      headers: this.getHeaders(),
    });
  }

  putDocente(docente: DocenteInterface): Observable<any> {
    return this.httpClient.put<any>(`${this.apiUrl}/${docente.id}`, docente, {
      headers: this.getHeaders(),
    });
  }
